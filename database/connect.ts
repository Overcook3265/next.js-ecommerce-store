...
//  This method to connect to DB and change from snake to camel here is fine, but not as flexible as the other used in this file:
...
// Better, more flexible method to connect to database incl. comments:
